			...
			if ($('#mainb').length ){
				  ...
				  echartBar.setOption({
					...
					series: [{
					  name: 'CPM(₩)',
					  type: 'bar',
					  data: [1216, 712, 1703, 1706, 1686, 1480, 1459, 1426, 972, 1106, 1421, 1609],
					  markPoint: {
						data: [{
						  type: 'max',
						  name: '최댓값'
					  ...
					  name: 'CPC(%)',
					  type: 'bar',
					  data: [246, 398, 284, 270, 214, 218, 212, 240, 227, 239, 247, 268],
					  markPoint: {
						data: [{
						  type: 'max',
						  name: '최댓값'
			...
			if ($('#echart_line').length ){ 
			  ...
			  echartLine.setOption({
				...
				series: [{
				  ...
				  data: [0.49, 0.18, 0.60, 0.63, 0.79, 0.68, 0.69, 0.60, 0.43, 0.46, 0.57, 0.60]
				}]
			  });
