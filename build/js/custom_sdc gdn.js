			...
			if ($('#mainb').length ){
				  ...
				  echartBar.setOption({
					...
					series: [{
					  name: 'CPM(₩)',
					  type: 'bar',
					  data: [1073, 1048, 691, 427, 496, 422, 777, 891, 359, 870, 2246, 3048],
					  markPoint: {
						data: [{
						  type: 'max',
						  name: '최댓값'
					  ...
					  name: 'CPC(%)',
					  type: 'bar',
					  data: [170, 174, 183, 208, 130, 144, 173, 244, 136, 144, 176, 266],
					  markPoint: {
						data: [{
						  type: 'max',
						  name: '최댓값'
			...
			if ($('#echart_line').length ){ 
			  ...
			  echartLine.setOption({
				...
				series: [{
				  ...
				  data: [0.63, 0.60, 0.38, 0.20, 0.38, 0.29, 0.45, 0.37, 0.26, 0.60, 1.28, 1.14]
				}]
			  });
