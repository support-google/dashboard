		...
		function init_echarts() {
			...
			if ($('#mainb').length ){
				  ...
				  echartBar.setOption({
					...
					xAxis: [{
					  type: 'category',
					  data: ['21/09', '21/10', '21/11', '21/12', '22/01', '22/02', '22/03', '22/04', '22/05', '22/06', '22/07', '22/08', '21/09', '21/10', '22/11', '22/12']
					}],
					yAxis: [{
					  type: 'value'
					}],
					series: [{
					  name: 'CPM(₩)',
					  type: 'bar',
					  data: [901, 1073, 1048, 691, 427, 496, 422, 777, 891, 359, 870, 2246, 3048, 1734, 1210, 1913],
					  markPoint: {
						data: [{
						  type: 'max',
						  name: '최댓값'
					  ...
					  name: 'CPC(%)',
					  type: 'bar',
					  data: [147, 170, 174, 183, 208, 130, 144, 173, 244, 136, 144, 176, 266, 194, 276, 263],
					  markPoint: {
						data: [{
						  type: 'max',
						  name: '최댓값'
			...
			if ($('#echart_line').length ){ 
			  ...
			  echartLine.setOption({
				...
				series: [{
				  ...
				  data: [0.61, 0.63, 0.60, 0.38, 0.20, 0.38, 0.29, 0.45, 0.37, 0.26, 0.60, 1.28, 1.14, 0.89, 0.44, 0.73]
				}]
			  });
