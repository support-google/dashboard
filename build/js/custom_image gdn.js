		...
		function init_echarts() {
			...
			if ($('#mainb').length ){
				  ...
				  echartBar.setOption({
					...
					xAxis: [{
					  type: 'category',
					  data: ['21/09', '21/10', '21/11', '21/12', '22/01', '22/02', '22/03', '22/04', '22/05', '22/06', '22/08', '22/09', '22/09', '22/10', '22/11']
					}],
					yAxis: [{
					  type: 'value'
					}],
					series: [{
					  name: 'CPM(₩)',
					  type: 'bar',
					  data: [570, 572, 712, 658, 671, 581, 519, 537, 597, 736, 651, 564, 607, 600, 667],
					  markPoint: {
						data: [{
						  type: 'max',
						  name: '최댓값'
					  ...
					  name: 'CPC(%)',
					  type: 'bar',
					  data: [346, 348, 398, 333, 334, 327, 307, 348, 327, 336, 336, 350, 364, 390, 353],
					  markPoint: {
						data: [{
						  type: 'max',
						  name: '최댓값'
			...
			if ($('#echart_line').length ){ 
			  ...
			  echartLine.setOption({
				...
				series: [{
				  ...
				  data: [0.16, 0.16, 0.18, 0.20, 0.20, 0.18, 0.17, 0.15, 0.18, 0.22, 0.19, 0.16, 0.17, 0.15, 0.19]
				}]
			  });
