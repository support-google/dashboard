			...
			if ($('#mainb').length ){
				  ...
				  echartBar.setOption({
					...
					series: [{
					  name: 'CPM(₩)',
					  type: 'bar',
					  data: [570, 572, 712, 658, 671, 581, 519, 537, 597, 736, 651, 564],
					  markPoint: {
						data: [{
						  type: 'max',
						  name: '최댓값'
					  ...
					  name: 'CPC(%)',
					  type: 'bar',
					  data: [346, 348, 398, 333, 334, 327, 307, 348, 327, 336, 336, 350],
					  markPoint: {
						data: [{
						  type: 'max',
						  name: '최댓값'
			...
			if ($('#echart_line').length ){ 
			  ...
			  echartLine.setOption({
				...
				series: [{
				  ...
				  data: [0.16, 0.16, 0.18, 0.20, 0.20, 0.18, 0.17, 0.15, 0.18, 0.22, 0.19, 0.16]
				}]
			  });
